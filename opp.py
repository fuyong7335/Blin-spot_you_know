...
# --- 質問項目 ---
q1 = st.text_input("Q1：最近、誰かに言われた一言で「なぜか心にひっかかった」言葉はありますか？（例：「真面目だね」「冷たいところもあるよね」）")
q2 = st.text_input("Q2：その言葉を聞いた時、どんな気持ちが一瞬よぎりましたか？（例：「え、そんなつもりないのに…」「ちょっとドキッとした」）")
q3 = st.text_input("Q3：どんな場面だったか、ざっくりでも思い出せますか？（例：「会議のあと」「SNSでやり取り中」）")
q4 = st.text_input("Q4：その言葉の『何が』引っかかったのだと思いますか？（例：「自分ではそう思っていなかった」「図星を突かれた気がした」）")
q5 = st.text_input("Q5：その瞬間、心の中でどんな“つぶやき”がありましたか？（例：「それは違うって」「やっぱりそう思われてたか…」）")
q6 = st.text_area("Q6：あなたは、自分のことをどんなふうに“思われていたい”ですか？思いつくままに書いてみてください。\n（例：頼れる人、やさしい人、気にしすぎない人 など）")
